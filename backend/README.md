...
## Project Structure
    ...
    ├── plant_identificatio_43857  # Django project configurations
...
1. Clone this repo and `cd plant_identificatio_43857`
...
2. Clone this repo and `cd plant_identificatio_43857`
